...
public class homeFrm extends JFrame {
	...
	// Thêm code vào Jlist displayCode
	...
	public homeFrm() {
		...
		// bắt sự kiện cho nút Sắp xếp tăng dần
		...
		JLabel lblNewLabel_6 = new JLabel("Thời gian thực hiện thuật toán: ");
